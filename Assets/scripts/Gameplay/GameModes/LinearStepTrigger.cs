...
public class LinearStepTrigger : MonoBehaviour {
	...
	private LevelParameters LevelSetup;
	private LinearLevelSetup LinearSetup;
	...
	public void Setup () 
	{
//		string path = "Linear/" + _levMan.NAME + "/Steps/";
//		string mainPath = "Linear/" + _levMan.NAME + "/";
...
//
//		SETUP = Resources.Load(mainPath + "Setup") as LevelParameters;
